...
// this binding is not present in ES6 error functions
function removeItem() {
...
function completeItem(){
  var item = this.parentNode.parentNode;
  var parent = item.parentNode;
  // now we have to check which list it belongs because we wish to toggle lists
  var id = parent.id;
  var target;
  ...
  if(id === 'todo'){
    ...
    // It's a todo item completed and needs to be redone
...
var addItemTodo = (text) => {
  ...
  // Add a click event for removing item
  ...
  // Add a click event for completing items
...
// this is tthe skeleton of the html element to be inserted in the DOM
//  <li>
//   This is  a todo
//   <div class="buttons">
//     <button class="remove">
